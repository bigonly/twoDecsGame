...
sealed class PlayerOneWayPlatformSystem : IEcsRunSystem
{
    ...
    private readonly
        EcsFilter<PlayerOneWayPlatformComponent, OneWayPlatformComponent, PlatformAvailabilityDurationComponent> playerOneWayPlatformFilter = null;
    public void Run()
    {
        foreach (var i in playerOneWayPlatformFilter)
        {
            ref var entity = ref playerOneWayPlatformFilter.GetEntity(i);
            ref var playerOneWayPlatformComponent = ref playerOneWayPlatformFilter.Get1(i);
            ref var oneWayPlatformComponent = ref playerOneWayPlatformFilter.Get2(i);
            ref var delay = ref playerOneWayPlatformFilter.Get3(i);
